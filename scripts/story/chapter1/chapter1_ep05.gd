...
func chapter1_ep5_script():
	...
	await novel_interface.show_dialog("……我为什么要脸红啊……",GameConfig.player_name)
	novel_interface.change_expression("normal")
	await novel_interface.show_dialog("果然……\n变成女生这种事，跟谁也说不出口吧……",GameConfig.player_name)
	await novel_interface.show_dialog("刚才仔细的检查了房间。\n唯一的异常是床边多出一根金属球棒。",GameConfig.player_name)
	novel_interface.change_expression("stare")
	await novel_interface.show_dialog("昨天的梦里研究中心遭到了袭击。\n我用这根球棒战斗过……",GameConfig.player_name)
	novel_interface.change_expression("normal")
	await novel_interface.show_dialog("如果那也能算作战斗的话……",GameConfig.player_name)
	await novel_interface.show_dialog("后来整个城市都灰飞烟灭了……",GameConfig.player_name)
	novel_interface.change_expression("stare")
	await novel_interface.show_dialog("对了，查一下手机！\n如果真的发生过，这样的事件一定有报导的！",GameConfig.player_name)
	novel_interface.change_expression("normal")
	await novel_interface.show_dialog("恐怖袭击之类的新闻，并没有……",GameConfig.player_name)
	await novel_interface.show_dialog("太好了，果然只是梦吗……",GameConfig.player_name)
	novel_interface.change_expression("stare")
	await novel_interface.show_dialog("咦？这是——？",GameConfig.player_name)
	await novel_interface.hide_character()
	...
	await novel_interface.show_dialog("感觉……必须再去一趟研究中心才行！",GameConfig.player_name)
	novel_interface.change_expression("normal")
	await novel_interface.show_dialog("关于昨天的梦，还有我身体的事。\n总觉得去了研究所说不定就能明白些什么了。",GameConfig.player_name)
	await novel_interface.show_dialog("好！我出门了！",GameConfig.player_name)
	await novel_interface.hide_character()
	...
	await novel_interface.show_dialog("说来……\n我的样子，完全是可疑人士吧……",GameConfig.player_name)
	await novel_interface.hide_character()
	...
	novel_interface.show_character("ren_trans","normal")
	await novel_interface.show_dialog("嗯……一鼓作气就来到了这里，可是接下来该怎么办呢。",GameConfig.player_name)
	await novel_interface.show_dialog("不像是会发生恐怖袭击的样子啊，有那么多的保\n安。",GameConfig.player_name)
	await novel_interface.show_dialog("不过这也难怪，有收容品消失了嘛……",GameConfig.player_name)
	await novel_interface.hide_character()
	...
	await novel_interface.show_dialog("吓！？",GameConfig.player_name)
	...
	await novel_interface.show_dialog("吓！又、又怎么了吗……？",GameConfig.player_name)
	novel_interface.character_light(0.35,"smile")
	novel_interface.character_2nd_dark()
	...
	await novel_interface.hide_character()
	novel_interface.show_character("ren_trans","normal")
	await novel_interface.show_dialog("好……好的，那再见！",GameConfig.player_name)
	novel_interface.change_expression("shy")
	await novel_interface.show_dialog("（小姑娘什么的称呼，好不习惯啊……）",GameConfig.player_name)
	novel_interface.change_expression("normal")
	await novel_interface.show_dialog("呜——肯定有什么线索。\n可是进不去……",GameConfig.player_name)
	await novel_interface.show_dialog("……只能乖乖回去了吧。",GameConfig.player_name)
	...
	await novel_interface.show_dialog("咦？我从刚才起就一直在往车站走，但道路好像不对劲？",GameConfig.player_name)
	novel_interface.change_expression("stare")
	await novel_interface.show_dialog("呃？\n怎么回事？？？",GameConfig.player_name)
	novel_interface.change_expression("normal")
	await novel_interface.show_dialog("我迷路了吗……",GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("witch_first")
	await novel_interface.show_dialog("唧——！\n…věta…hrích…！！","神情古怪的不良")
	await novel_interface.hide_character()
	novel_interface.show_character("ren_trans","normal")
	await novel_interface.show_dialog("这群人怎么怪怪的……\n这些家伙……她们在说什么？",GameConfig.player_name)
	novel_interface.change_expression("shock")
	await novel_interface.show_dialog("呜哇啊啊啊啊！！！！",GameConfig.player_name)
	await novel_interface.show_dialog("这些家伙，冲我来了！？",GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("witch_first")
	await novel_interface.show_dialog("…Mors…！！","神情古怪的不良")
	await novel_interface.hide_character()
	novel_interface.show_character("ren_trans","shock")
	await novel_interface.show_dialog("得赶快逃！",GameConfig.player_name)
	novel_interface.change_expression("shy")
	await novel_interface.show_dialog("……呼呼……！就算想逃……\n衣服和鞋都这么松垮，根本跑不快……！",GameConfig.player_name)
	await novel_interface.hide_character()
	novel_interface.show_character("witch_first")
	...
	await novel_interface.show_dialog("诶？球棒……？",GameConfig.player_name)
	await novel_interface.hide_character()
