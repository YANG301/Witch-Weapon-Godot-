...
- 将工程打包安装到本地 `mods` 文件夹
- 分享你的创意作品给其他玩家
- 登录账号后上传到在线平台，等待审核后供其他玩家下载

## 推荐工作流

推荐优先使用游戏内置的同人编辑器制作 Mod：

1. 启动游戏并进入主菜单。
2. 点击“同人”入口。
3. 打开编辑器，创建或选择一个 Mod 工程。
4. 在工程中编辑剧集、导入资源并测试剧情。
5. 使用“安装到 Mod”将工程导出到本地 `mods` 文件夹。
6. 登录账号后，可将 Mod 上传到在线平台分享。

手动创建文件夹仍然可用，适合需要直接维护资源结构或排查问题的情况。
...
- 2026-06-07: 更新到 1.3.1α，补充内置编辑器、本地安装和在线上传流程
