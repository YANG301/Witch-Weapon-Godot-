...
- 本项目不是官方作品，与原游戏公司无任何关联。
- 《魔女兵器》及其相关美术素材、音乐、字体、角色设定、剧情等内容版权归北京水琴铃信息技术有限公司所有。
- 本项目代码由开发者 YANG301 使用 Godot 引擎原创开发，项目使用 Godot Engine，遵循其 MIT 许可证。
- 本项目采用自定义开源许可证，详见 [LICENSE](./LICENSE) 文件；允许学习、研究、修改、分享，禁止商业使用和闭源分发，并要求署名与相同方式共享。
- 欢迎提交 Issue 和 Pull Request，但不得提交侵犯版权的内容；贡献代码将同样以本项目许可证开源。
- 使用者应遵守相关法律法规，自行承担使用风险；如有侵权请联系删除。

## 联系方式

- 开发者：YANG301
- 邮箱：yangyi35@outlook.com
- QQ 群：1078249413 魔女兵器编辑器测试群
